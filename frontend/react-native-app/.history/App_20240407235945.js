  ...
  return (
    <View style={[styles.container, darkMode && styles.darkContainer]}>
      ...
      <View style={styles.horizontalContainer}>
        <TouchableOpacity style={[styles.horizontalBox, darkMode && styles.darkBox]} onPress={() => handleOptionClick('Settings')}>
          <Text style={[styles.text, darkMode && styles.darkText]}>Settings</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.horizontalBox, darkMode && styles.darkBox]} onPress={() => handleOptionClick('About')}>
